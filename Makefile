...
CFLAGS = -g2 -I. -Iws2812b -Iwrapper -mmcu=$(DEVICE) -DF_CPU=$(F_CPU)
...
$(AURORA): light_ws2812.o wrapper.o
				@echo Building $@
				@$(CC) $(CFLAGS) -o objects/light_ws2812.o wrapper/wrapper.o $(TCP_OBJ) $@.c ws2812b/light_ws2812.c
...
clean:
				rm -f *.hex wrapper/*.o objects/*.o objects/*.lss
