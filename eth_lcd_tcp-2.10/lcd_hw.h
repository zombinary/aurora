...
#define LCD_DATA_PIN_D7  PORTD7	/* arbitrary pin for LCD data line D7 */
#define LCD_DATA_PIN_D6  PORTD6	/* arbitrary pin for LCD data line D6 */
#define LCD_DATA_PIN_D5  PORTD5	/* arbitrary pin for LCD data line D5 */
